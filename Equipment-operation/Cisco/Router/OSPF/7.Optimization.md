...
>使用ACL有缺點，以這張拓樸為例，ACL是沒辦法做到從R2再發佈EIGRP只允許192.168.1.0/24至R1，其餘的192.168.2.0/24、192.168.3.0/24、192.168.4.0/32、192.168.5.0/32都不允許，因為ACL寫成access-list 10 permit 192.168.1.0 0.0.255.255會允許192.168.0.0/16至192.168.0.0/32的路由都發佈出去，沒辦法過濾更細部的遮罩，所以須使用prefix-list或route-map才能做到
