...
router ospfv3 10
    address-family ipv4 unicast 
        distribute-list 1 out e0/0 eigrp 20 #套用ACL到開啟OSPF的介面，這樣EIGRP再發佈進來的路由就會被ACL過濾掉
#IPv6 
...
```bash
#IPv4 prefix-list 
ip prefix-list OSPF-Filter seq 5 permit 192.168.0.0/16 le 24 #seq只是序號，像是ACL的序號，不會影響到prefix-list的功能，在刪除prefix-list時可以指定序號刪除
router ospfv3 10 
    address-family ipv4 unicast 
        distribute-list prefix OSPF-Filter out eigrp 20 
#IPv6 prefix-list 
ipv6 prefix-list OSPF-Filter seq 5 deny 2001:
```
